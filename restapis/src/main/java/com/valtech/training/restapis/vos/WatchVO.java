...
public class WatchVO {
	...
	public WatchVO(long id, String brand, String model, String color, float price, String type) {
		this.id = id;
		this.brand = brand;
		this.model = model;
		this.color = color;
	...
	public static WatchVO from (Watch w) {
		return new WatchVO(w.getId(),w.getBrand(),w.getModel(),w.getColor(),w.getPrice(),w.getType());
	}
