...
//	@CollectionTable(name="movie_actors",joinColumns = @JoinColumn(name="movie_id",referencedColumnName = "id") )
	...
	public String toString() {
		return "Movie [name=" + name + ", genre=" + genre + ", language=" + language + ", actors=" + actors + "]";
	}
