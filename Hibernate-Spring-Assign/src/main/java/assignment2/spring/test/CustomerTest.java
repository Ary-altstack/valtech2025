	package assignment2.spring.test;
...
import assignment2.spring.Order;
import assignment2.spring.OrderService;
...
//		Customer c1 = new Customer("Lennon",40,"Liverpool","Liverpool");
//		Customer c =(new Customer("Deepak",22,"Ahmeda","Gurgaon"));
//		cs.save(new Customer("Abhi",18,"Ahmedabad","Ahmedabad"));
//		cs.save(c);
		
//		Item i = new Item("Drums", "Bang Boom Bang",100,100,200);
